...
def convert_2_(path,binary,fstring,ext):#DO NOT EDIT. NO PARAMETERS TO TWEAK HERE
...
# (a tiny test file will be created, converted and then deleted)
# (you will to provide your own test file)
binaries={
...
def convert(files):
    ...
    fl=sort(list(set(files)-skip));print(c80(' Images found: '))
    for i in formats:
